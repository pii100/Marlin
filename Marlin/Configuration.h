/**
 * REV: 04.23.16, HICi3-1.1.0-RC5
 * A custom configuration.h for HICTOP Reprap Prusa I3 "Ebay aluminum frame version"
 *
 * Current HIC i3 default hardware configuration:
 * 1. single extruder (E0)
 * 2. discount 4x20 LCD controller with rotary control
 * 3. 'red' HICTOP 'MPX.3' RAMPS 1.3 control board (Power Outputs: Extruder, Fan, Bed)
 *
 * NOTE: major changes for HIC i3 search for 'CL:'
 *
 */
...
#define STRING_CONFIG_H_AUTHOR "(Blackstone, HICTOP i3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "HICi3 v1.1.9"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "b5471910-910f-4cc8-aa8c-298305c6bd09"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 398, 798}
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -20   // CL: HICi3, was =10 : X offset: -left  [of the nozzle] +right
#define Y_PROBE_OFFSET_FROM_EXTRUDER 25  // CL: HICi3, was =10 : Y offset: -front [of the nozzle] +behind
#define Z_PROBE_OFFSET_FROM_EXTRUDER -.6   // Z offset: -below [the nozzle] (always negative!)
